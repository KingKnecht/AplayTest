...
{
    public  sealed  class UndoManager : APlayTest.Server.UndoManagerSkeleton
    {
        ...
        public override void onUndoRedoTo(HistoryEntry destinationEntry)
        {
            _undoService.UndoRedoTo(new sbardos.UndoFramework.HistoryEntry(destinationEntry.Id, destinationEntry.Description), _clientId);
        }
