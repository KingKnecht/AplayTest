...
namespace Undo.Server
{
  public class Task : Undo.Server.TaskSkeleton
  {
    ...
    public override void onRemoveSubTask(int taskId__, Undo.Server.Client client__)
    {
      // Autogenerated log message for call
      APlay.Common.Logging.Logger.LogDesigned(2,"Task.onRemoveSubTask called","Undo.Server.Task");
      /// TODO: add your code here
    }
  }
